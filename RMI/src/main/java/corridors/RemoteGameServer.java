...
public class RemoteGameServer implements Game {
    ...
    public RemoteGameServer() {    // works when an object on Server is created
        ...
        latticeSides = new String[nLatticeSymbRow][nLatticeSymbCol];
        // colors of the sides
        cellColors = new String[nLatticeSymbRow][nLatticeSymbCol];
        ...
        gamerColors[0] = ANSI_BLUE;   // color gamer 1
        gamerColors[1] = ANSI_PURPLE; // color gamer 2
    ...
    @Override
    public String[][] getLatticeSides() throws RemoteException { // it is needed to transfer the lattice to the client
        return this.latticeSides;
    }

    @Override
    public String[][] getCellColors() throws RemoteException {
        return this.cellColors;
    }

    public boolean gamerMove(int cellRowIdx, int cellColIdx, String cellSide) throws RemoteException {
        ...
        // color the side
        cellColors[sideRowIdx][sideColIdx] = gamerColors[currGamerId-1];
    ...
    @Override
    public int getCurrGamerId() throws RemoteException {
        return this.currGamerId;
    }

    @Override
    public int getNumCellRows() throws RemoteException {
        return this.nLatticeCellRow;
    }

    @Override
    public int getNumCellCols() throws RemoteException {
